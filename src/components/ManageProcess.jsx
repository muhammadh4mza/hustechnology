...
const ManageProcess = () => {
  ...
  const handleContactSubmit = (e) => {
    e.preventDefault();
    console.log('Management request submitted:', contactForm);
    ...
    alert('Thank you for your IP management request! Our team will contact you within 24 hours.');
  };
          ...
          >
            ...
            >
              <div className="sticky top-0 bg-blue-600 p-4 border-b flex justify-between items-center">
                <h2 className="text-xl font-bold text-gray-100">IP Management Request</h2>
              ...
              <div className="flex p-2 items-center text-xs mb-6 bg-gray-700 rounded-b-lg mx-6">
                ...
                <span className="text-gray-200">Please fill out the form below and our IP management specialists will contact you within 24 hours.</span>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-1 gap-6 px-6">
                <div className="md:col-span-2">
                  <div className="bg-gray-700 rounded-2xl shadow-sm p-6">
                    <h1 className="font-bold text-lg mb-4 text-white">Management Information</h1>
                    <form onSubmit={handleContactSubmit}>
                      <div className="grid gap-6 sm:grid-cols-2">
                        ...
                        <div>
                          <label className="text-gray-300 text-sm">Number of IPs to Manage<span className="text-red-500">*</span></label>
                        ...
                        <div>
                          <label className="text-gray-300 text-sm">Management Type<span className="text-red-500">*</span></label>
                          <select name="managementType" value={contactForm.managementType} onChange={handleContactChange} required className="form-select rounded border-gray-600 bg-gray-600 text-white w-full p-2">
                        ...
                        <div className="sm:col-span-2">
                          ...
                          <textarea 
                            ...
                            placeholder="Tell us about your specific management needs and any technical requirements..."
                          />
                        </div>
                      </div>
                      <div className="mt-6">
