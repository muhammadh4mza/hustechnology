...
import { List, FileText, Send } from 'lucide-react';
...
const SellProcess = () => {
  ...
  const steps = [
    {
      number: 1,
      title: "Listing",
      description: "Contact us or list the IP resource you want to sell on our platform",
      icon: List
    },
    {
      number: 2,
      title: "Agreement",
      description: "Agree on the selling price",
      icon: FileText
    },
    {
      number: 3,
      title: "Transaction",
      description: "Huscomintl will take care of and assist in the whole IP transfer process",
      icon: Send
    }
  ];
  ...
  const handleContactSubmit = (e) => {
    e.preventDefault();
    console.log('Sell request submitted:', contactForm);
    ...
    alert('Thank you for your IPv4 selling request! Our team will contact you within 24 hours.');
  };
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            The Process of Selling IP Addresses <span className="text-cyan-300">Within 48 Hours</span>
          </h2>
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-blue-100/90">
              Discover the simple process of selling IP addresses with Huscomintl. Our user-friendly interface ensures a seamless experience, making the complex task of selling IP addresses accessible to all. We guide you through each step to ensure a smooth transaction.If you're looking for a trusted partner to sell IP addresses, visit Huscomintl for more info.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 flex items-center">
              <span>Sell IPv4 Addresses Now</span>
              <svg
          ...
          >
            ...
            >
              <div className="sticky top-0 bg-blue-600 p-4 border-b flex justify-between items-center">
                <h2 className="text-xl font-bold text-gray-100">IPv4 Selling Request</h2>
              ...
              <div className="flex p-2 items-center text-xs mb-6 bg-gray-700 rounded-b-lg mx-6">
                ...
                <span className="text-gray-200">Please fill out the form below and our IP sales specialists will contact you within 24 hours.</span>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-1 gap-6 px-6">
                <div className="md:col-span-2">
                  <div className="bg-gray-700 rounded-2xl shadow-sm p-6">
                    <h1 className="font-bold text-lg mb-4 text-white">Selling Information</h1>
                    <form onSubmit={handleContactSubmit}>
                      <div className="grid gap-6 sm:grid-cols-2">
                        ...
                        <div>
                          <label className="text-gray-300 text-sm">IP Block Size<span className="text-red-500">*</span></label>
                        ...
                        <div>
                          <label className="text-gray-300 text-sm">Number of Blocks<span className="text-red-500">*</span></label>
                          <input type="text" name="ipCount" value={contactForm.ipCount} onChange={handleContactChange} required className="form-input rounded border-gray-600 bg-gray-600 text-white w-full p-2" placeholder="e.g., 1, 2, 5" />
                        </div>
                        <div>
                          <label className="text-gray-300 text-sm">Expected Price (USD)<span className="text-red-500">*</span></label>
                          <input type="text" name="expectedPrice" value={contactForm.expectedPrice} onChange={handleContactChange} required className="form-input rounded border-gray-600 bg-gray-600 text-white w-full p-2" placeholder="e.g., $10,000" />
                        </div>
                        <div className="sm:col-span-2">
                          <label className="text-gray-300 text-sm">Additional Information<span className="text-red-500">*</span></label>
                          <textarea 
                            name="message" 
                            ...
                            placeholder="Tell us about your IP addresses (age, usage history, RIR membership, etc.)"
                          />
                        </div>
                      </div>
                      <div className="mt-6">
