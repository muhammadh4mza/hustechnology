...
import { UserCheck, Globe, Headphones } from 'lucide-react';
  ...
  const reasons = [
    {
      ...
      description: "Huscomintl has been providing IP management services for more than 5 years and we never disappointed our customers.",
      Icon: UserCheck
    },
    {
      id: 2,
      title: "Served 1k+ customers globally",
      description: "Huscomintl has successfully helped more than 1,000 clients earn profit by managing their IP addresses.",
      Icon: Globe
    },
    {
      id: 3,
      title: "Ongoing support 24x7",
      description: "Our highly skillful and experienced IP team will provide ongoing management service and support to you.",
      Icon: Headphones
    }
  ];
