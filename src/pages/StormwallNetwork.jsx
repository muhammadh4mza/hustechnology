...
import StormwallNetworkBanner from '../components/StormwallNetworkBanner';
import GlobalFilteringNetwork from '../components/GlobalFilteringNetwork';
import StormWallCards from '../components/StormWallCards';
import WhoBenefitsAntiDDoS from '../components/WhoBenefitsAntiDDoS';
import ClientPortalSection from '../components/ClientPortalSection';


const StormwallNetwork = () => {
  return (
    <div className="relative bg-[#F5F5F5] min-h-screen overflow-hidden">
      ...
      <div className="relative z-10">
        <Navbar />
        <StormwallNetworkBanner />
        <GlobalFilteringNetwork />
        <StormWallCards />
        <WhoBenefitsAntiDDoS />
        <ClientPortalSection />
...
export default StormwallNetwork;